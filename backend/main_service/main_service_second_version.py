...
#	print("client disconnected ok")
	...
	#print(tempGateway)
	#print(self.time_of_changes['A'])
	#print(self.time_of_changes[tempGateway])
	self.times.append(datetime.datetime.now().time().second)
	print("times = ", self.times)
	#print(self.time_of_changes[tempGateway])

	#check which values are not 0
	#compare saved time
#	print(self.time_of_changes)
#	times = []
#	for elem in self.time_of_changes:
#		if self.time_of_changes[elem] != -1:
#			times.append(self.time_of_changes[elem])
#	print(times)
#	length1 = len(times)
#	print(length1-1)
	#differ = datetime.datetime.now().time().second - times[length1-1]
